...
- **✅ Ajustes pedidos por Francisco tras probar el panel de revisión (17 ago 2026):**
  ...
  - **Categorización de gastos** (para poder sacar informes de "en qué se gasta" más adelante): lista cerrada de 14 categorías (`src/lib/cost-categories.ts` -- Movilización, Alimentación, Alojamiento, Arriendo de audio, Arriendo de luces, Arriendo de espacio, Honorarios, Catering, Transporte de equipos, Producción y staff, Seguridad, Permisos y derechos de autor, Marketing y difusión, Otros). Selector obligatorio al reportar un gasto desde `/gastos`; selector opcional (no retroactivo, los ítems viejos quedan sin categoría) en cada fila de la Planilla de costos y al agregar un ítem nuevo a mano. Columna nueva agregada también a la tabla de impresión de Costos.
