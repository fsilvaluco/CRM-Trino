...
export async function GET(
  ...
  // la organización podía leer/reemplazar los tramos de venta de cualquier
  // evento ajeno. Corregido con el mismo patrón que `eventos/[id]`.
